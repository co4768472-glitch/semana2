...
islowerCase1 = "Ella se fue , me avandono y destroso mi corazon"
minuscula = islowerCase1.islowerCase()
print("minuscula", minuscula)

elemento1 = "solo mayusculas"
respuesta = elemento1.isupper()
print("respuesta", respuesta)

respuesta = elemento1.upper().isupper()
print("respuesta", respuesta)


fraseIconica1 = "El  chavo del 8"

fraseIconica1 = fraseIconica1.title().istitle()
print("fraseIconica", fraseIconica1)
